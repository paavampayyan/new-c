...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/kidiloskahyper45)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/kidiloskahyper45)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/0157b8c240fb049cadc8f.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help",callback_data="help_back"),InlineKeyboardButton(text="Developer",url="https://t.me/rosebakthan")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="Developer ",url="https://t.me/rosebakthan")]]))
        return
